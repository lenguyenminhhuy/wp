...
if (isset($_POST['submit']))
{
    ...
    $_SESSION['movie1'] = $_POST['movie']['day'];
          ...
          <div class="row">
            <div class="col-lg-6">
              <fieldset class="standard">
                ...
                <div class="text-danger">* All dropdown value must be selected (Please select 0 if you don't want to buy the ticket)</div>
            ...
            <div class="col-lg-6">
              <fieldset class="customer-info">
                ...
                <input type="text" name="cust[name]" id="cust-name" value="<?php if (!preg_match("/^[a-zA-Z \-.']{1,100}$/", $name)){echo $_POST['cust']['name'];} ?>" 
                  required>
                  <!-- pattern="^[a-zA-Z \-.']{1,100}$" title="Western name only" -->
